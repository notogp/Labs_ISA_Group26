...
vlog -work ./work ../netlist/myfir_unfolded_pipelined.v
vlog -work ./work ../tb/tb_filter_unfolded_pipelined.v
vsim -c -do swa_synopsis.tcl

vcd2saif -input ../vcd/myfir_syn_unfolded_pipelined.vcd -output ../saif/myfir_syn_unfolded_pipelined.saif
